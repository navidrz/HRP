...
### مقدمه‌ای برای روایت پروژه

در دنیای پرتلاطم سرمایه‌گذاری، مدیریت پرتفوها و کاهش ریسک همیشه از موضوعات اساسی بوده است. این پروژه تلاشی است برای ارائه راه‌حلی جامع و علمی به منظور بهینه‌سازی پرتفو سرمایه‌گذاری با بهره‌گیری از روش‌های نوینی همچون **Hierarchical Risk Parity (HRP)** و **Conditional Value at Risk (CVaR)**. در طول این روایت، نه تنها تلاش‌های دقیق برای پیاده‌سازی این راهکارها را به اشتراک می‌گذارم، بلکه جزئیات فنی و تصمیمات کلیدی در فرآیند توسعه را نیز بازگو خواهم کرد.

---

### نگاهی به ایده اصلی

بهینه‌سازی پرتفو از دیرباز دغدغه‌ی اصلی فعالان مالی و سرمایه‌گذاران بوده است. هدف اصلی در این زمینه، ایجاد تعادلی میان بازدهی و ریسک است؛ تعادلی که بتواند با در نظر گرفتن شرایط پویای بازار، از دارایی‌های موجود بیشترین بازده ممکن را در سطح معقولی از ریسک فراهم کند. پروژه حاضر به دنبال پاسخی علمی به این نیاز است؛ پاسخی که از روش‌های پیشرفته و داده‌محور بهره می‌برد.
...
### پیشنهادات برای گسترش کد

1. **گسترش دامنه داده‌ها:**
   - با افزودن داده‌های بین‌المللی و تنوع‌بخشی به نمادهای مورد بررسی، می‌توان کارایی مدل‌ها را در بازارهای مختلف ارزیابی کرد.

2. **ارزیابی بلندمدت پرتفوها:**
   - با بررسی عملکرد پرتفوها در بازه‌های زمانی طولانی‌تر، می‌توان به نتایج دقیق‌تری درباره پایداری آن‌ها دست یافت.
